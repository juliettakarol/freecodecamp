...
//   return a string with the current count and the string Bet if the count is 
//   positive, or Hold if the count is zero or negative. The current count and 
...
console.log((cc(2), cc(2), cc(2), cc('K'), cc('A')))
