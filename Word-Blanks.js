...
// a verb, an adjective and an adverb. You need to 
// form a complete sentence using words of your choice, 
...
const wordBlanks = "My "+ myNoun + " a very "+myAdjective+ ", and he " + myVerb + " very " + myAdverb; // Change this line
